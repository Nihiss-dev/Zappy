...
bool			ParseCmd::parse_pin(const std::string &msg)
{
  ...
  if ((iss >> _ressources[ParseCmd::RES_NOURRITURE]) == NULL)
    {
      std::cout << "Warning: invalid args for " << _funcName << " command" << std::endl;
      return false;
    }
  if ((iss >> _ressources[ParseCmd::RES_LINEMATE]) == NULL)
    {
      std::cout << "Warning: invalid args for " << _funcName << " command" << std::endl;
      return false;
    }
  if ((iss >> _ressources[ParseCmd::RES_DERAUMERE]) == NULL)
    {
      std::cout << "Warning: invalid args for " << _funcName << " command" << std::endl;
      return false;
    }
  if ((iss >> _ressources[ParseCmd::RES_SIBUR]) == NULL)
    {
      std::cout << "Warning: invalid args for " << _funcName << " command" << std::endl;
      return false;
    }
  if ((iss >> _ressources[ParseCmd::RES_MENDIANE]) == NULL)
    {
      std::cout << "Warning: invalid args for " << _funcName << " command" << std::endl;
      return false;
    }
  if ((iss >> _ressources[ParseCmd::RES_PHIRAS]) == NULL)
    {
      std::cout << "Warning: invalid args for " << _funcName << " command" << std::endl;
      return false;
    }
  if ((iss >> _ressources[ParseCmd::RES_THYSTAME]) == NULL)
    {
      std::cout << "Warning: invalid args for " << _funcName << " command" << std::endl;
      return false;
    }
